...
class CorrespondenceChecker:
    ...
    """
    def Check(self, source, target, corres, transformation):
        """
...
class GlobalOptimizationMethod:
    ...
    """
    def OptimizePoseGraph(self, pose_graph, criteria, option):
        """
        Run pose graph optimization.
        
        Args:
            pose_graph (open3d.pipelines.registration.PoseGraph): The pose graph to be optimized (in-place).
...
class TransformationEstimation:
    ...
    """
    def compute_rmse(self, source, target, corres):
        """
...
def compute_fpfh_feature(input, search_param):
    ...
    """
def correspondences_from_features(source_features, target_features, mutual_filter = False, mutual_consistency_ratio = 0.10000000149011612):
    """
    ...
    """
def evaluate_registration(source, target, max_correspondence_distance, transformation = ...):
    """
    ...
    """
def get_information_matrix_from_point_clouds(source, target, max_correspondence_distance, transformation):
    """
...
def global_optimization(pose_graph, method, criteria, option):
    ...
    Args:
        pose_graph (open3d.pipelines.registration.PoseGraph): The pose_graph to be optimized (in-place).
        method (open3d.pipelines.registration.GlobalOptimizationMethod): Global optimization method. Either ``GlobalOptimizationGaussNewton()`` or ``GlobalOptimizationLevenbergMarquardt()``.
        criteria (open3d.pipelines.registration.GlobalOptimizationConvergenceCriteria): Global optimization convergence criteria.
        option (open3d.pipelines.registration.GlobalOptimizationOption): Global optimization option.
    
    Returns:
        None
    """
def registration_colored_icp(*args, **kwargs):
    """
    ...
    Returns:
        open3d.pipelines.registration.RegistrationResult
    """
def registration_fgr_based_on_correspondence(*args, **kwargs):
    """
    ...
    Returns:
        open3d.pipelines.registration.RegistrationResult
    """
def registration_fgr_based_on_feature_matching(*args, **kwargs):
    """
    ...
    Returns:
        open3d.pipelines.registration.RegistrationResult
    """
def registration_generalized_icp(*args, **kwargs):
    """
...
def registration_icp(*args, **kwargs):
    ...
    Returns:
        open3d.pipelines.registration.RegistrationResult
    """
def registration_ransac_based_on_correspondence(*args, **kwargs):
    """
    ...
    Returns:
        open3d.pipelines.registration.RegistrationResult
    """
def registration_ransac_based_on_feature_matching(*args, **kwargs):
    """
