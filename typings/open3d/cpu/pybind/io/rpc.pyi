...
def destroy_zmq_context() -> None:
    ...
    """
def set_active_camera(path, connection = None):
    """
    ...
    Returns:
        bool
    """
def set_legacy_camera(camera, path = '', time = 0, layer = '', connection = None):
    """
...
def set_mesh_data(*args, **kwargs):
    ...
    Returns:
        bool
    """
def set_point_cloud(pcd, path = '', time = 0, layer = '', connection = None):
    """
    ...
    Returns:
        bool
    """
def set_time(time, connection = None):
    """
