...
import typing
__all__ = ['AxisAlignedBoundingBox', 'Cubic', 'DrawableGeometry', 'Geometry', 'Image', 'InterpType', 'Lanczos', 'LineSet', 'Linear', 'Nearest', 'OrientedBoundingBox', 'PointCloud', 'RGBDImage', 'RaycastingScene', 'Super', 'TensorMap', 'TriangleMesh', 'VoxelBlockGrid']
...
class Image(Geometry):
    ...
    def to(*args, **kwargs):
        ...
        2. to(self, dtype, copy=False, scale=None, offset=0.0)
    ...
    def is_empty(self):
        ...
        Returns:
            bool
        """
    def linear_transform(self, scale = 1.0, offset = 0.0):
        """
...
class LineSet(Geometry, DrawableGeometry):
    ...
    def from_legacy(*args, **kwargs):
        ...
        Args:
            ...
            device (open3d.core.Device, optional, default=CPU:0): The device where the resulting LineSet resides.
    ...
    def cuda(self, device_id: int = 0) -> LineSet:
        ...
        """
    def extrude_linear(self, vector: open3d.cpu.pybind.core.Tensor, scale: float = 1.0, capping: bool = True) -> ...:
        """
        ...
        """
    def extrude_rotation(self, angle: float, axis: open3d.cpu.pybind.core.Tensor, resolution: int = 16, translation: float = 0.0, capping: bool = True) -> ...:
        """
...
class OrientedBoundingBox(Geometry, DrawableGeometry):
    ...
    def create_from_axis_aligned_bounding_box(aabb):
        ...
        """
    @staticmethod
    def create_from_points(points, robust = ...):
        """
        ...
        Args:
            ...
            robust (bool, optional): If set to true uses a more robust method which works in degenerate cases but introduces noise to the points coordinates. Default value:
        
                False) -> open3d.t.geometry.OrientedBoundingBox
                Creates an oriented bounding box using a PCA.
                Note that this is only an approximation to the minimum oriented bounding box
                that could be computed for example with O'Rourke's algorithm
                (cf. http://cs.smith.edu/~jorourke/Papers/MinVolBox.pdf
             ()
...
class PointCloud(Geometry, DrawableGeometry):
    ...
    """
    @staticmethod
    def create_from_depth_image(*args, **kwargs):
        """
        ...
        """
    @staticmethod
    def create_from_rgbd_image(*args, **kwargs):
        """
    ...
    def from_legacy(pcd_legacy: open3d.cpu.pybind.geometry.PointCloud, dtype: open3d.cpu.pybind.core.Dtype = ..., device: open3d.cpu.pybind.core.Device = ...) -> PointCloud:
        ...
        """
    @staticmethod
    def orient_normals_to_align_with_direction(*args, **kwargs):
        """
        ...
        """
    @staticmethod
    def orient_normals_towards_camera_location(*args, **kwargs):
        """
        Function to orient the normals of a point cloud.
    ...
    def get_oriented_bounding_box(self) -> ...:
        ...
        """
    def hidden_point_removal(self, camera_location: open3d.cpu.pybind.core.Tensor, radius: float) -> tuple[..., open3d.cpu.pybind.core.Tensor]:
        """
    ...
    def normalize_normals(self) -> PointCloud:
        ...
        """
    def orient_normals_consistent_tangent_plane(self, k: int, lambda: float = 0.0, cos_alpha_tol: float = 1.0) -> None:
        """
    ...
    def pca_partition(self, max_points: int) -> int:
        ...
        """
    def project_to_depth_image(self, width: int, height: int, intrinsics: open3d.cpu.pybind.core.Tensor, extrinsics: open3d.cpu.pybind.core.Tensor = ..., depth_scale: float = 1000.0, depth_max: float = 3.0) -> ...:
        """
        Project a point cloud to a depth image.
        """
    def project_to_rgbd_image(self, width: int, height: int, intrinsics: open3d.cpu.pybind.core.Tensor, extrinsics: open3d.cpu.pybind.core.Tensor = ..., depth_scale: float = 1000.0, depth_max: float = 3.0) -> ...:
        """
    ...
    def remove_non_finite_points(self, remove_nan: bool = True, remove_infinite: bool = True) -> tuple[PointCloud, open3d.cpu.pybind.core.Tensor]:
        ...
        """
    def remove_radius_outliers(self, nb_points, search_radius):
        """
    ...
    def select_by_index(self, indices, invert = False, remove_duplicates = False):
        ...
        Returns:
            open3d.t.geometry.PointCloud
        """
    def select_by_mask(self, boolean_mask, invert = False):
        """
    ...
    def uniform_down_sample(self, every_k_points):
        ...
        Returns:
            open3d.t.geometry.PointCloud
        """
    def voxel_down_sample(self, voxel_size, reduction = 'mean'):
        """
...
class TriangleMesh(Geometry, DrawableGeometry):
    ...
    def create_arrow(*args, **kwargs):
        ...
        Args:
            ...
            device (open3d.core.Device, optional, default=CPU:0): Device of the create octahedron.
    ...
    def create_box(*args, **kwargs):
        ...
        Args:
            ...
            float_dtype (open3d.core.Dtype, optional, default=Float32): Float_dtype, Float32 or Float64.
            int_dtype (open3d.core.Dtype, optional, default=Int64): Int_dtype, Int32 or Int64.
            device (open3d.core.Device, optional, default=CPU:0): Device of the create mesh.
    ...
    def create_cone(*args, **kwargs):
        ...
        """
    @staticmethod
    def create_coordinate_frame(*args, **kwargs):
        """
    ...
    def create_cylinder(*args, **kwargs):
        ...
        """
    @staticmethod
    def create_icosahedron(*args, **kwargs):
        """
    ...
    def create_mobius(*args, **kwargs):
        ...
        """
    @staticmethod
    def create_octahedron(*args, **kwargs):
        """
    ...
    def create_sphere(*args, **kwargs):
        ...
        Args:
            ...
            float_dtype (open3d.core.Dtype, optional, default=Float32): Float_dtype, Float32 or Float64.
            int_dtype (open3d.core.Dtype, optional, default=Int64): Int_dtype, Int32 or Int64.
            device (open3d.core.Device, optional, default=CPU:0): Device of the create sphere.
        
        Returns:
            open3d.t.geometry.TriangleMesh
        """
    @staticmethod
    def create_tetrahedron(*args, **kwargs):
        """
        ...
        Args:
            ...
            float_dtype (open3d.core.Dtype, optional, default=Float32): Float_dtype, Float32 or Float64.
            int_dtype (open3d.core.Dtype, optional, default=Int64): Int_dtype, Int32 or Int64.
            device (open3d.core.Device, optional, default=CPU:0): Device of the create tetrahedron.
    ...
    def scale(self, scale: float, center: open3d.cpu.pybind.core.Tensor) -> TriangleMesh:
        ...
        Scale points.
        """
    def select_by_index(self, indices: open3d.cpu.pybind.core.Tensor) -> TriangleMesh:
        """
