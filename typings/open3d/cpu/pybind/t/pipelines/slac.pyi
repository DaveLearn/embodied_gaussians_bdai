...
class control_grid:
    ...
    def compactify(self) -> None:
        ...
        """
    @typing.overload
    def deform(self, pointcloud: ...) -> ...:
        """
        Non-rigidly deform a point cloud using the control grid.
        """
    @typing.overload
    def deform(self, depth: ..., intrinsics: open3d.cpu.pybind.core.Tensor, extrinsics: open3d.cpu.pybind.core.Tensor, depth_scale: float, depth_max: float) -> ...:
        """
        ...
        """
    @typing.overload
    def deform(self, rgbd: ..., intrinsics: open3d.cpu.pybind.core.Tensor, extrinsics: open3d.cpu.pybind.core.Tensor, depth_scale: float, depth_max: float) -> ...:
        """
    ...
    def get_neighbor_grid_map(self) -> tuple[open3d.cpu.pybind.core.Tensor, open3d.cpu.pybind.core.Tensor, open3d.cpu.pybind.core.Tensor]:
        ...
        """
    def parameterize(self, pointcloud: ...) -> ...:
        """
...
class slac_optimizer_params:
    ...
    def voxel_size(self, arg0: float) -> None:
        ...
def run_rigid_optimizer_for_fragments(fragment_filenames, fragment_pose_graph, params = ..., debug_option = ...):
    """
    ...
    Args:
        ...
        params (open3d.t.pipelines.slac.slac_optimizer_params, optional, default=SLACOptimizerParams[max_iterations=5, voxel_size=5.000000e-02, distance_threshold=7.000000e-02, fitness_threshold=3.000000e-01, regularizer_weight=1.000000e+00, device=CPU:0, slac_folder=].): slac_optimizer_params Parameters to tune in optimization.
    ...
    """
def run_slac_optimizer_for_fragments(fragment_filenames, fragment_pose_graph, params = ..., debug_option = ...):
    """
    ...
    """
def save_correspondences_for_pointclouds(fnames_processed, fragment_pose_graph, params = ..., debug_option = ...):
    """
